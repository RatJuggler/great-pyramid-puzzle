        ...
        context("with valid configuration data file 1", function () {
            it("should return a correctly initialised instance", function () {
                ...
                const expectedToString = "Puzzle Type: test-valid\n" +
                    ...
                    "TilePosition: 1, Contains Tile: [null, Orientation: null], Joins: (1-A->3-1-B)(1-B->4-1-B)(1-C->2-1-B)\n" +
                    "Face: 2, Tile Positions: 1, Joins: (2-A->3-C)(2-B->1-C)(2-C->4-A)\n" +
                    "TilePosition: 1, Contains Tile: [null, Orientation: null], Joins: (1-A->3-1-C)(1-B->1-1-C)(1-C->4-1-A)\n" +
                    "Face: 3, Tile Positions: 1, Joins: (3-A->4-C)(3-B->1-A)(3-C->2-A)\n" +
                    "TilePosition: 1, Contains Tile: [null, Orientation: null], Joins: (1-A->4-1-C)(1-B->1-1-A)(1-C->2-1-A)\n" +
                    "Face: 4, Tile Positions: 1, Joins: (4-A->2-C)(4-B->1-B)(4-C->3-A)\n" +
                    "TilePosition: 1, Contains Tile: [null, Orientation: null], Joins: (1-A->2-1-C)(1-B->1-1-B)(1-C->3-1-A)\n";
