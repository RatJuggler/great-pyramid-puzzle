        ...
        context("with valid layout configuration file 1", function () {
            ...
            it("should return the correct toString result", function () {
                const expectedToString = "Puzzle Type: test-valid\n" +
                    ...
                    "TilePosition: 1, On Face: 1, Contains Tile: [null], In Orientation: 0, Joins: (1-A->3-1-B)(1-B->4-1-B)(1-C->2-1-B)\n" +
                    "Face: 2, Tile Positions: 1, Joins: (2-A->3-C)(2-B->1-C)(2-C->4-A)\n" +
                    "TilePosition: 1, On Face: 2, Contains Tile: [null], In Orientation: 0, Joins: (1-A->3-1-C)(1-B->1-1-C)(1-C->4-1-A)\n" +
                    "Face: 3, Tile Positions: 1, Joins: (3-A->4-C)(3-B->1-A)(3-C->2-A)\n" +
                    "TilePosition: 1, On Face: 3, Contains Tile: [null], In Orientation: 0, Joins: (1-A->4-1-C)(1-B->1-1-A)(1-C->2-1-A)\n" +
                    "Face: 4, Tile Positions: 1, Joins: (4-A->2-C)(4-B->1-B)(4-C->3-A)\n" +
                    "TilePosition: 1, On Face: 4, Contains Tile: [null], In Orientation: 0, Joins: (1-A->2-1-C)(1-B->1-1-B)(1-C->3-1-A)\n";
        ...
        context("with invalid layout configuration file 2", function () {
            ...
            it("should fail the integrity check", function () {
                const expectedFailure = [false,
                    ...
                    "TilePosition: 1, On Face: 1, Contains Tile: [null], In Orientation: 0, Joins: \n"];
