...
draw(face_a);
label("A1", (point(face_a, 0)--point(face_a, 1)), S, side_label);
label("A3", (point(face_a, 1)--point(face_a, 2)), E, side_label);
label("A2", (point(face_a, 2)--point(face_a, 3)), W, side_label);

dot(face_b_center);
label("Face B", face_b_center, N, face_label);
draw(face_b);
label("B1", (point(face_b, 0)--point(face_b, 1)), E, side_label);
label("B2", (point(face_b, 2)--point(face_b, 3)), N, side_label);
label("B3", (point(face_b, 1)--point(face_b, 2)), W, side_label);

dot(face_c_center);
label("Face C", face_c_center, S, face_label);
draw(face_c);
label("C3", (point(face_c, 0)--point(face_c, 1)), E, side_label);
label("C2", (point(face_c, 1)--point(face_c, 2)), E, side_label);
label("C1", (point(face_c, 2)--point(face_c, 3)), S, side_label);

dot(face_d_center);
label("Face D", face_d_center, S, face_label);
draw(face_d);
label("D2", (point(face_d, 0)--point(face_d, 1)), W, side_label);
label("D1", (point(face_d, 1)--point(face_d, 2)), W, side_label);
label("D3", (point(face_d, 2)--point(face_d, 3)), S, side_label);
