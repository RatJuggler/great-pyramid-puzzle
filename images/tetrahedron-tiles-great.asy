...
// Face A tiles
path tile_a1 = shift(0, -tile_offset_y2) * shift(face_a_center) * scale(tile_scale) * polygon(3);
path tile_a2 = shift(0, tile_offset_y2) * shift(face_a_center) * scale(tile_scale) * rotate(60) * polygon(3);
path tile_a3 = shift(tile_offset_x, tile_offset_y) * shift(face_a_center) * scale(tile_scale) * polygon(3);
path tile_a4 = shift(tile_offset_x * 2, tile_offset_y2) * shift(face_a_center) * scale(tile_scale) * rotate(60) * polygon(3);
path tile_a5 = shift(tile_offset_x, tile_offset_y - tile_offset_y2) * shift(face_a_center) * scale(tile_scale) * rotate(60) * polygon(3);
path tile_a6 = shift(0, -tile_offset_y2 * 2) * shift(face_a_center) * scale(tile_scale) * rotate(60) * polygon(3);
path tile_a7 = shift(-tile_offset_x, tile_offset_y - tile_offset_y2) * shift(face_a_center) * scale(tile_scale) * rotate(60) * polygon(3);
path tile_a8 = shift(-tile_offset_x, tile_offset_y) * shift(face_a_center) * scale(tile_scale) * polygon(3);
path tile_a9 = shift(-tile_offset_x * 2, tile_offset_y2) * shift(face_a_center) * scale(tile_scale) * rotate(60) * polygon(3);
